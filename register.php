        ...
        <div class="register-form text-center">
          <form id="contact-form" method="post" action="http://www.themeht.com/sassaht/ltr/php/contact.php">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <input id="form_password1" type="password" name="password" class="form-control" placeholder="Conform Password" required="required" data-error="Conform Password is required.">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                <div class="remember-checkbox clearfix mb-5">
                  <div class="form-check">
                    <input class="form-check-input float-none" type="checkbox" value="" id="flexCheckChecked" checked>
                    <label class="form-check-label" for="flexCheckChecked">I agree to the term of use and privacy policy</label>
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12"> <a href="#" class="btn btn-theme btn-circle" data-text="Create Account"><span>C</span><span>r</span><span>e</span><span>a</span><span>t</span><span>e</span>
